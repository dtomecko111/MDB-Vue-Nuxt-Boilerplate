<template>
  ...
  <div class="container-fluid">
    ...
    <div class="card primary-header">
      <div class="card-body">
        <h1 class="h1 mb-4 text-white">Documents</h1>
        <p>
      ...
      <div class="card-body">
        <div class="table-responsive">
          ...
          >
            ...
            <tbody>
              <tr>
                <td><i class="fas fa-fw fa-file text-primary" /></td>
                <td>00/00/0000</td>
                <td>Terms of Service Agreement</td>
                <td>0000-000-0000</td>
                <td>PDF</td>
                <td><i class="fas fa-print text-primary" /></td>
              </tr>
              <tr>
                <td><i class="fas fa-fw fa-file text-primary" /></td>
                <td>00/00/0000</td>
