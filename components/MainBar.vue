    ...
    <div class="container">
      <div class="row align-items-streach justify-content-between">
        ...
        <nav id="site-navigation">
          ...
          <ul class="mega-menu-responsive megaMenu" style="display: block;">
            <li class="has-sublist"><a href="about-us.html" class="with-subcategories" title="About us"><span> About Us</span></a>
              <div class="plus-button"></div>
              <div class="sublist-wrap">
                <ul class="sublist">
                  <li class="back-button"><span>Back</span></li>
                  <li><a href="who-we-are.html" title="Who We Are"><span> Who We Are</span></a></li>
                  <li><a href="why-choose-clearview.html" title="Why Choose Clearview"><span> Why Choose Clearview</span></a></li>
                  <li><a href="post.html" title="Partnerships"><span> Partnerships</span></a></li>
                </ul>
              </div>
            </li>
            <li><a href="rates-plans.html" title="Electricity Rates &amp; Plans"><span> Electricity Rates &amp; Plans</span></a></li>
            <li class="has-sublist"><a href="customer-care.html" class="with-subcategories" title="Customer Care"><span> Customer Care</span></a>
              <div class="plus-button"></div>
              <div class="sublist-wrap">
                <ul class="sublist">
