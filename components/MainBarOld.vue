      ...
      <div class="row align-items-streach justify-content-between">
        ...
        <nav id="site-navigation">
          <ul class="mega-menu megaMenu" data-isrtlenabled="false" data-enableclickfordropdown="false">
            ...
            <li><a href="rates-plans" title="Electricity Rates &amp; Plans" class=""><span> Electricity Rates &amp; Plans</span></a></li>
            ...
            <li class="has-sublist"><a href="living-green" class="with-subcategories" title="Living Green"><span> Living Green</span></a>
              <div class="plus-button"></div>
              <div class="sublist-wrap">
                <ul class="sublist">
                  <li class="back-button"><span>Back</span></li>
